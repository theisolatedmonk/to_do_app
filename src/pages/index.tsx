...
export default function Todo() {
  return (
    <main className="flex bg-no-repeat  bg-top bg-[url('../images/bg-desktop-light.jpg')] min-h-screen flex-col items-center justify-center">
      <div className=" items-center gap-3 font-sans text-[hsl(235,19%,35%)] flex flex-col text-sm lg:flex">
        ...
        <div className=" flex flex-col gap-4 shadow-md">
          ...
          <div className="flex flex-col shadow-sm gap-0">
            ...
            <div className="flex gap-2 justify-between p-2 text-[9px] items-center  bg-white w-96 h-8 rounded-sm shadow-md hsl(236,9%,61%)">
        ...
        <div className=" font-sans font-semibold text- text-[9px]">Drag and drop to reader list</div>
      </div>
    </main>
  );
}
